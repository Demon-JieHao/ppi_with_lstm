...
conv1_fmaps = 32   #  N. feature maps in the 1st conv. layer
...
with tf.name_scope('second_conv'):
    conv3 = tf.layers.conv1d(x1, filters=conv1_fmaps, kernel_size=conv1_ksize,
                             strides=conv1_stride, padding=conv1_pad,
                             kernel_initializer=he_init,
                             activation=tf.nn.relu, name='conv3')

    conv4 = tf.layers.conv1d(x2, filters=conv1_fmaps, kernel_size=conv1_ksize,
                             strides=conv1_stride, padding=conv1_pad,
                             kernel_initializer=he_init,
